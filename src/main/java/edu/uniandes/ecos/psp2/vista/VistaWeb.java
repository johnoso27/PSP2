...
public class VistaWeb {
    ...
    public static void mostrarFormunlarioInicial(HttpServletRequest req, HttpServletResponse resp)
        ...
        pw.println("<h1>Programa PSP 2</h1>");
        pw.write("<form  method=\"post\">\n"
                + "<div><h2>Cálculo de la integral numérica usando la regla de Simpson</h2></div> \n"
    ...
    public static void mostrarResultados(HttpServletRequest req, HttpServletResponse resp, Double resultado, Integer segmento, Double x, Double e, Double dof, String titulo)
        ...
        r.println("<table>");
        r.println("<tr>");
        r.println("<th>Integral numérica</th>");
        r.println("</tr>");
        r.println("<tr>");
        ...
        r.println("<h4>Valores base: </h4><label>X: " + x + "</br>Segmento: " + segmento + "</br>E: " + margen + "</br>Dof: " + dof + "</label>");
        r.println("</td>");
        r.println("</table>");
